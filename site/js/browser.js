...
(function( $ ) {
	function Browser( elem ) {
		this.$elem = $(elem);
		this.limit = 15; // entries per page
		this.browse = null;
		this.model = null;
		this.selection = null;
		this.offset = null;		
	...
	Browser.prototype = {
		...
		printPage : function() {
			...
			for (var i = _this.offset; i < list.length; i++) {
				...
				var text = "";			
				var img = (list[i].image !== undefined) ? '<img src="'+list[i].image.value+'/thumbs/000001.jpg" height="100" alt="" class="img-thumbnail pull-left" />' : "";
